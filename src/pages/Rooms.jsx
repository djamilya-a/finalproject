      ...
      <section className='bg-[#313F38]'>
        <div className="room h-[675px]">
          <div className="w-[1400px] mx-auto">
            <h2 className='text-[125px]/[150px] text-[#FCD043] pt-[50px]'>Superior <br />twin</h2>
        ...
        <div className="w-[1200px] mx-auto pt-[100px]">
          ...
          <div className="flex justify-between items-center">
            <div className="flex flex-col gap-[50px] items-start justify-start label1">
              <img src={Bath} alt="" />
              <h4 className='text-[#1B3B36] text-[36px] leading-none'>Superior twin</h4>
              <p className='text-[18px] text-[#1B3B36]'>All rooms in Bank Hotel have a special <br /> charm achieved through a combination of <br /> modern functional design and original 20th <br /> century layout.  </p>
            </div>
            <div className="flex flex-col gap-[40px] items-start justify-start">
              <img src={Broom} alt="" />
              <p className='text-[#1B3B36] text-[18px]'>The Superior twin includes two functional zones: a <br /> living room with the best Italian furniture, and an <br /> isolated cozy bedroom with a large bed. Here, you will <br /> find space both for work and comfortable rest. Hotel <br /> offers supreme comfort and outstanding 24-hour room <br />
