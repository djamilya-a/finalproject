...
export default function Register() {
  ...
  return (
    <div className="pt-[70px] pb-[20px] flex flex-col items-center justify-start bg-[#FFFCF6]">
      <div className="bg-[#FFFCF6] flex flex-col items-center justify-center gap-[50px] px-[300px] py-[50px] border border-[#FCD043] border-[2px] rounded-[20px]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col items-center justify-center gap-[30px]">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-[300px] bg-[#FCD043] border-none text-[#1B3B36] py-[15px] rounded-[10px] text-[16px] text-[#1B3B36] hover:bg-blue-600 transition lg:w-[400px]"
          >
